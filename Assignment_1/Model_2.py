# Labels according to model 2 -->  finiteautomata/bertweet-base-sentiment-analysis
...
for filename in os.listdir(folder_path):
    if filename.endswith(".csv"):
        ...
        file_df["Semantic Label 2"] = file_sentiments

        # Save the updated file DataFrame
        folder_path_new= folder_path = folder_path = '//content//sample_data'

        updated_file_path = os.path.join(folder_path_new, "Model_2" + filename)
